...
Probability of AQ is 0.5 * 0.75= 0.375

Probability of Aq and aQ is 0.5 * 0.25 + 0.5 * 0.25 * 0.25
...
**Probability of AB haplotypes:**

aqb= ABQ =0.5 * 0.6 * 0.7(getting A and B with no crossovers) + 0.5 * 0.3 *0.4 (getting A and B as a result of 2 crossovers) = 0.27

AqB = 0.5 * 0.3 * 0.4 (getting 2 crossovers) = 0.06

aQB= 0.5 * 0.4 * 0.7(crossover in AQ) + 0.5 * 0.6 * 0.3(Crossover in QB) = 0.23

AQb = 0.5 * 0.6 * 0.3= 0.09

Aqb= 0.5 * 0.4 * 0.7 = 0.14


The probability of Q given AB haplotype = (0.27-0.06)/0.27 = 0.77

The probability of q given AB haplotype =  1-0.77= 0.23

The probability of QQ given AABB genotype = 0.77*0.77= 0.5929

The probability of qq given AABB genotype = 0.23*0.23= 0.0529

The probability of Qq/qQ given AABB genotype = 2 * (0.77 * 0.23)= 0.3542

**The proportion of lines that have QQ given AABB genotype is 0.59**



#### **B. What is the expected value for offspring with the genotype AABB? (3 pts)**
QQ given AABB= 0.5929

qq given AABB= 0.0529

Qq given AABB= 0.3542

```{r}
(0.5929*5) + (0.3542*0) + (0.0529*-5) 
```
...
Probability of QQ given AA = 0.6*0.6= 0.36

Probability of qq given AA= 0.4*0.4 = 0.16
...
Probability of QQ given BB = 0.7*0.7= 0.49

Probability of qq given BB= 0.3*0.3 = 0.09
...
**The recombination frequency of a marker has to be smaller than 0.23 to be as effective as two marker selection in MAS. **
